...
<div className='w-full  md:w-1/2  rounded-2xl p-4 bg-gray-200 mt-7 shadow'>
 ...
 <div className='mt-3' >
    ...
    <p onClick={() => alert('password reset feature coming soon !')}
    className='hover:cursor-pointer text-sm mt-2 text-blue-400'> 
      Forget Password?</p>
  </div>
...
<div className='mt-3'>
  <p className='text-gray-500 text-right'>
     Don't have an account ?<Link className='text-blue-500'
